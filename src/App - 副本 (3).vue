...
export default {
  ...
  methods: {
    ...
    initialize() {
		...
		var defaultRender = mdeditor.renderer.rules.blockquote_open || function(tokens, idx, options, env, self) {
		  return self.renderToken(tokens, idx, options);
		};

		mdeditor.renderer.rules.blockquote_open = function (tokens, idx, options, env, self) {
